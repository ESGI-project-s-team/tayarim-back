...
INSERT INTO DEPENSE (LIBELLE, PRIX, DATE, IDLOGEMENT) VALUES ('Electricity', 20.00, (SELECT DATEADD(DAY, -31, CURRENT_TIMESTAMP)), 1);
...
VALUES ('RESA-293249', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        ...
        (SELECT DATEADD(DAY, -70, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -60, CURRENT_TIMESTAMP)), 1,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293250', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -60, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -50, CURRENT_TIMESTAMP)), 1,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293251', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -50, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -40, CURRENT_TIMESTAMP)), 1,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293252', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -40, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -30, CURRENT_TIMESTAMP)), 1,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293253', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -20, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -10, CURRENT_TIMESTAMP)), 1,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
...
VALUES ('RESA-293149', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -70, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -60, CURRENT_TIMESTAMP)), 2,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293150', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -60, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -50, CURRENT_TIMESTAMP)), 2,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293151', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -50, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -40, CURRENT_TIMESTAMP)), 2,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293152', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -40, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -30, CURRENT_TIMESTAMP)), 2,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
VALUES ('RESA-293153', 'done', 'luclient@gmail.com', '0698762345', 'Lient', 'Luc', 1, 25.30,
        SUBSTRING(CURRENT_TIME(), 1, 5), SUBSTRING(CURRENT_TIME(), 1, 5),
        (SELECT DATEADD(DAY, -20, CURRENT_TIMESTAMP)),
        (SELECT DATEADD(DAY, -10, CURRENT_TIMESTAMP)), 2,
        CURRENT_DATE());
INSERT INTO RESERVATION (IDCOMMANDE, STATUT, EMAIL, NUMTEL, NOM, PRENOM, NBPERSONNES, MONTANT,
                         CHECKIN, CHECKOUT,
                         DATEARRIVEE, DATEDEPART, IDLOGEMENT, DATERESERVATION)
