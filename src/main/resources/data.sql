...
INSERT INTO IMAGELOGEMENT (URL, IDLOGEMENT, ISMAINIMAGE) VALUES ( 'House%20images/mainImage1.jpg', (SELECT max(ID) FROM LOGEMENT), TRUE );
INSERT INTO IMAGELOGEMENT (URL, IDLOGEMENT, ISMAINIMAGE) VALUES ( 'House%20images/secondImage1-1.jpg', (SELECT max(ID) FROM LOGEMENT), FALSE );
...
INSERT INTO IMAGELOGEMENT (URL, IDLOGEMENT, ISMAINIMAGE) VALUES ( 'https://via.placeholder.com/150', (SELECT max(ID) FROM LOGEMENT), TRUE );
