...
INSERT INTO ADMINISTRATEUR (IDUSER, ISSUPERADMIN) VALUES ((SELECT max(ID) FROM UTILISATEUR), TRUE);

INSERT INTO UTILISATEUR (NOM, PRENOM, EMAIL, NUMTEL, MOTDEPASSE) VALUES ('Ilad', 'Min', 'iladmin@gmail.com', '+330634567891', '$2a$12$3hQDUblvPShmuQg/.g0Qk.wHAGjqPL54RMO/lNgsei/HQGo0ZLIYm');
INSERT INTO ADMINISTRATEUR (IDUSER, ISSUPERADMIN) VALUES ((SELECT max(ID) FROM UTILISATEUR), FALSE);