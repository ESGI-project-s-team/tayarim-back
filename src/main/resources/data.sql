...
INSERT INTO UTILISATEUR (NOM, PRENOM, EMAIL, NUMTEL, MOTDEPASSE) VALUES ('Jean', 'Paul', 'jeanpaul@gmail.com', '0623456789', '$2a$12$3hQDUblvPShmuQg/.g0Qk.wHAGjqPL54RMO/lNgsei/HQGo0ZLIYm');
INSERT INTO PROPRIETAIRE (IDUSER, DATEINSCRIPTION) VALUES ((SELECT max(ID) FROM UTILISATEUR), CURRENT_TIME());

INSERT INTO UTILISATEUR (NOM, PRENOM, EMAIL, NUMTEL, MOTDEPASSE) VALUES ('Jade', 'Min', 'jadmin@gmail.com', '0634567890', '$2a$12$3hQDUblvPShmuQg/.g0Qk.wHAGjqPL54RMO/lNgsei/HQGo0ZLIYm');
