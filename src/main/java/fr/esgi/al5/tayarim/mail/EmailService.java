...
public class EmailService {
  ...
  public void sendAccountConfirmationEmail(String nom, String prenom, String email,
    ...
    String msgHeaderValidationAccount = messageSource.getMessage("msg_header_validation_account", null, locale);
    ...
    String msgSignatureYaronTayarim = messageSource.getMessage("msg_signature_yaron_tayarim", null, locale);
  ...
  public void sendFactureEmail(String email, String nom, String prenom, String numeroFacture,
      ...
      String lang) {
        ...
        messageSource.setDefaultEncoding("UTF-8");
        Locale locale = (lang.equals("en") ? Locale.ENGLISH : Locale.FRANCE);
        String msgHeaderInvoiceReceived = messageSource.getMessage("msg_header_invoice_received", null, locale);
        String msgHello = messageSource.getMessage("msg_hello", null, locale);
  ...
  public void sendCreationReservationEmail(String email, String nom, String prenom,
      ...
      String adresseReservation, String dateArrivee, String nbNuits, String nbPersonnes, String lang) {
        ResourceBundleMessageSource messageSource = new ResourceBundleMessageSource();
        messageSource.setBasename("messages");
        messageSource.setDefaultEncoding("UTF-8");
        Locale locale = (lang.equals("en") ? Locale.ENGLISH : Locale.FRANCE);
        String msgHeaderReservationConfirmation = messageSource.getMessage("msg_header_reservation_confirmation", null, locale);
        String msgHello = messageSource.getMessage("msg_hello", null, locale);
        String msgReservationSuccess = messageSource.getMessage("msg_reservation_success", null, locale);
        String msgReservationNotice = messageSource.getMessage("msg_reservation_notice", null, locale);
        String msgReservationImageAlt = messageSource.getMessage("msg_reservation_image_alt", null, locale);
        ...
        String msgReservationAddress = messageSource.getMessage("msg_reservation_address", null, locale);
        ...
        RequestBody body = RequestBody.create(mediaType,
            "{"
                ...
                + "\"msg_help\":\"" + msgHelp + "\","
                + "\"url_gestion_reservation\":\"" + "https://tayarim.com/"+ lang + "/modification-reservation" + "\","
  ...
  public void sendAnnulationReservationEmail(String email, String nom, String prenom,
      ...
      String adresseReservation, String dateArrivee, String nbNuits, String nbPersonnes, String lang) {
        ...
        messageSource.setDefaultEncoding("UTF-8");
        Locale locale = (lang.equals("en") ? Locale.ENGLISH : Locale.FRANCE);
        String msgHeaderReservationCancellation = messageSource.getMessage("msg_header_reservation_cancellation", null, locale);
        String msgHello = messageSource.getMessage("msg_hello", null, locale);
        String msgReservationCancelled = messageSource.getMessage("msg_reservation_cancelled", null, locale);
        String msgReservationImageAlt = messageSource.getMessage("msg_reservation_image_alt", null, locale);
        String msgReservationNumber = messageSource.getMessage("msg_reservation_number", null, locale);
        String msgReservationDate = messageSource.getMessage("msg_reservation_date", null, locale);
        String msgReservationAmount = messageSource.getMessage("msg_reservation_amount", null, locale);
  ...
  public void sendModificationReservationEmail(String email, String nom, String prenom,
      ...
      String adresseReservation, String dateArrivee, String nbNuits, String nbPersonnes, String lang) {
        ...
        messageSource.setDefaultEncoding("UTF-8");
        Locale locale = (lang.equals("en") ? Locale.ENGLISH : Locale.FRANCE);
        String msgHeaderReservationModification = messageSource.getMessage("msg_header_reservation_modification", null, locale);
        String msgHello = messageSource.getMessage("msg_hello", null, locale);
        String msgReservationModified = messageSource.getMessage("msg_reservation_modified", null, locale);
        String msgReservationImageAlt = messageSource.getMessage("msg_reservation_image_alt", null, locale);
        String msgReservationNumber = messageSource.getMessage("msg_reservation_number", null, locale);
        String msgReservationDate = messageSource.getMessage("msg_reservation_date", null, locale);
        String msgReservationAmount = messageSource.getMessage("msg_reservation_amount", null, locale);
  ...
  public void sendPasswordResetEmail(String email, String nom, String prenom,
      String lienReinitialisation, String lang) {
        ...
        messageSource.setDefaultEncoding("UTF-8");
        Locale locale = (lang.equals("en") ? Locale.ENGLISH : Locale.FRANCE);
        String msgHeaderPasswordReset = messageSource.getMessage("msg_header_password_reset", null, locale);
        String msgHello = messageSource.getMessage("msg_hello", null, locale);
        String msgPasswordResetRequest = messageSource.getMessage("msg_password_reset_request", null, locale);
        String msgResetPasswordLink = messageSource.getMessage("msg_reset_password_link", null, locale);
        String msgPasswordResetIgnore = messageSource.getMessage("msg_password_reset_ignore", null, locale);
        String msgHelp = messageSource.getMessage("msg_help", null, locale);
        String msgSincerely = messageSource.getMessage("msg_sincerely", null, locale);
        String msgSignatureYaronTayarim = messageSource.getMessage("msg_signature_yaron_tayarim", null, locale);
        String msgCopyright = messageSource.getMessage("msg_copyright", null, locale);
  ...
  public void sendClientMessageEmail(String message, String email, String emailClient,
      ...
      String prenom, String lang) {
        ...
        messageSource.setDefaultEncoding("UTF-8");
        Locale locale = (lang.equals("en") ? Locale.ENGLISH : Locale.FRANCE);
        String msgHeaderClientMessage = messageSource.getMessage("msg_header_client_message", null, locale);
        String msgClientMessageIntro = messageSource.getMessage("msg_client_message_intro", null, locale);
        String msgClientMessageReservation = messageSource.getMessage("msg_client_message_reservation", null, locale);
        String msgClientMessageLabel = messageSource.getMessage("msg_client_message_label", null, locale);
        String msgCopyright = messageSource.getMessage("msg_copyright", null, locale);
