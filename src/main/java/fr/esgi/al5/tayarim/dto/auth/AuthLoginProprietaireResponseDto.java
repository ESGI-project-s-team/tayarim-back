...
public class AuthLoginProprietaireResponseDto extends AuthLoginResponseDto {

  @NonNull
  private Boolean isPasswordUpdated;

  public AuthLoginProprietaireResponseDto(@NonNull Long id, @NonNull String token,
      @NonNull Boolean admin, @NonNull String nom, @NonNull String prenom, @NonNull String email,
      @NonNull String numTel, @NonNull Boolean isPasswordUpdated) {
